/**
 * S3 スクリーンショット生成(v0.0.6)。
 *   bun run scripts/s3-v006-capture.ts   (= package.json の "s3:capture:v006")
 *
 * v0.0.6 は自走エンジン core。4 新規画面(SCR-01〜04)をキャプチャする:
 *   SCR-01: 自走ボード(5 バッジ / default + empty)
 *   SCR-02: Inbox 要対応例外カード(default)
 *   SCR-03: プロジェクト管理(default + dialog)
 *   SCR-04: 振り返りメトリクス(default)
 *
...
const S3_DIR = resolve(import.meta.dir, "../aidlc-docs/v0.0.6/s3");
