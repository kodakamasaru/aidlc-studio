...
| 完了条件 | (1) 全 SCR に html + md + screenshots が揃う / (2) tokens.html が `bun run s3:capture` で tokens.png として撮れている / (3) ユーザーがブラウザで html を見て視覚意図を承認 / (4) screenshots/ が最新の html と一致(古いキャプチャが残っていない) |
